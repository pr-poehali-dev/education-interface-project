...
const documents = [
  ...
  'Аттестат об основном общем или среднем общем образовании',
  'СНИЛС (копия)',
...
const contacts = [
  {
    icon: 'MapPin',
    title: 'Адрес',
    value: 'г. Москва, ул. Академическая, д. 15, каб. 105',
  },
  {
    icon: 'Clock',
    title: 'Часы работы',
    value: 'Пн-Пт: 9:00-17:00, Сб: 10:00-14:00',
  },
  {
    icon: 'Phone',
    title: 'Телефон',
    value: '+7 (495) 555-00-55',
  },
  {
    icon: 'Mail',
    title: 'Email',
    value: 'admission@edu-institution.ru',
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              Порядок поступления, необходимые документы и сроки
            </p>
          </div>
        </div>
      </section>
